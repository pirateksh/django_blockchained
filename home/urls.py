...
urlpatterns = [
    ...
    path('add_employment_transaction/', views.add_employment_transaction, name='add_employment_transaction'),
    path('add_criminal_transaction/', views.add_criminal_transaction, name='add_criminal_transaction'),
    path('add_health_transaction/', views.add_health_transaction, name='add_health_transaction'),
